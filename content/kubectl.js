export default {
  ...
  sections: [
    {
      heading: "Inspect Resources",
      variant: "core",
      keywords: "get describe list pods deployments services yaml wide all",
      blocks: [
        {
          type: "table",
          head: ["Command", "Shows"],
    ...
    {
      heading: "Context & Namespace",
      variant: "core",
      keywords: "context namespace config current use switch cluster kubeconfig",
      blocks: [
        {
          type: "table",
          head: ["Command", "Does"],
        ...
        },
        {
          type: "callout",
          variant: "tip",
          title: "Know your context before you act.",
          body:
            "The same `kubectl delete` runs against whatever context is current — including prod. `kubectx` / `kubens` (or a shell prompt that shows the context) make the active target impossible to miss.",
        },
      ],
    },
    {
      heading: "Apply & Manage",
      variant: "web",
      keywords: "apply delete edit scale rollout restart undo manifest deploy",
      blocks: [
        {
          type: "table",
          head: ["Command", "Does"],
    ...
    },
    {
      heading: "Debugging",
      variant: "web",
      keywords: "debug logs exec shell port forward events previous",
      blocks: [
        {
          type: "table",
          head: ["Command", "Does"],
    ...
    {
      heading: "Nodes & Cluster",
      variant: "danger",
      keywords: "nodes cluster top resources info drain cordon capacity",
      blocks: [
        {
          type: "table",
          head: ["Command", "Shows / does"],
          rows: [
