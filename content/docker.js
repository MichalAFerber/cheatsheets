export default {
  ...
  sections: [
    {
      heading: "Images",
      variant: "core",
      keywords: "images build pull push tag list remove history",
      blocks: [
        {
          type: "table",
          head: ["Command", "Action"],
    ...
    },
    {
      heading: "Containers",
      variant: "core",
      keywords: "containers run start stop remove exec logs shell ps",
      blocks: [
        {
          type: "table",
          head: ["Command", "Action"],
    ...
    {
      heading: "Common run flags",
      variant: "web",
      keywords: "run flags detached port volume env name rm network interactive",
      blocks: [
        {
          type: "table",
          head: ["Flag", "Effect"],
        ...
        {
          type: "recipe",
          title: "A typical one-liner",
          lang: "bash",
          code: `docker run -d --name web --rm \\
  ...
  nginx:alpine`,
    ...
    },
    {
      heading: "Compose",
      variant: "web",
      keywords: "compose up down logs build ps services stack",
      blocks: [
        {
          type: "table",
          head: ["Command", "Action"],
    ...
    },
    {
      heading: "Clean Up",
      variant: "danger",
      badge: { class: "danger", label: "Destructive" },
      keywords: "cleanup prune remove disk space dangling volumes",
      blocks: [
        {
          type: "table",
        ...
        },
        {
          type: "callout",
          variant: "danger",
          title: "prune deletes without asking twice.",
          body:
            "`docker volume prune` can wipe database data living in an unused volume, and `system prune -a` removes every image no running container references. Check `docker system df` first.",
        },
      ],
    },
  ],
